		...
		<div class="public-ifame-leftnav">
			...
			<ul class="left-nav-list">
				...
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="?r=admin/article_manage" target="content">列表管理</a>|<a href="?r=admin/article_add" target="content">添加</a></li>
							<li><a href="?r=admin/cate_manage" target="content">分类管理</a></li>
						</ul>
					</div>
				</li>
				<li class="public-ifame-item">
					...
					<div class="ifame-item-sub">
						<ul>
							<li><a href="?r=admin/lytc_manage" target="content">信息列表</a>|<a href="#" target="content">添加</a></li>
							<li><a href="#" target="content">分类管理</a></li>
							<li><a href="#" target="content">分类管理</a></li>
							<li><a href="?r=admin/listbanner" target="content">列表页轮播管理</a></li>
